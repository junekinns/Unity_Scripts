...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class J_CarAudio : MonoBehaviour
    {
        ...
        private J_CarController m_CarController; // Reference to car we are controlling
        ...
        private void StartSound()
        {
            ...
            m_CarController = GetComponent<J_CarController>();

            // setup the simple audio source
            m_HighAccel = SetUpEngineAudioSource(highAccelClip);

            m_crashSound = SetUpCrashAudioSource(crashClip);
        ...
        [Range(0,1)]
        public float myVolumeController;
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                else
                {
                    ...
                    m_LowAccel.volume = lowFade*accFade * myVolumeController;
                    m_LowDecel.volume = lowFade*decFade * myVolumeController;
                    m_HighAccel.volume = highFade*accFade * myVolumeController;
                    m_HighDecel.volume = highFade*decFade * myVolumeController;
        ...
        private AudioSource SetUpCrashAudioSource(AudioClip crashSound)
        {
            AudioSource crashSource = gameObject.AddComponent<AudioSource>();
